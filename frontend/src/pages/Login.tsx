        ...
        <Card size="4" variant="surface">
          ...
          <form onSubmit={handleLogin}>
            <Flex direction="column" gap="4">
              ...
              <Button size="4" variant="solid" type="submit" highContrast>Sign In</Button>
              <Text align="center" size="2" color="gray">
                Don't have an account? <Link to="/register" style={{ color: 'var(--accent-9)', textDecoration: 'none', fontWeight: 500 }}>Sign Up</Link>
              </Text>
            </Flex>
          </form>
        </Card>
